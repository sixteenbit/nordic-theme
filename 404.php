		...
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found text-center">
				<header class="entry-header">
					<h1 class="entry-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'nordic-theme' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="entry-content grid-container">
					<div class="grid-x grid-padding-x">
						<div class="cell small-12 medium-10 medium-offset-1 large-8 large-offset-2">
							...
							<a class="button" href="<?php echo site_url(); ?>"><i class="fas fa-long-arrow-left"></i> <?php esc_html_e( 'Back Home', 'nordic-theme' ); ?></a>
						</div>
					</div>
				</div><!-- .page-content -->
			</section><!-- .error-404 -->
