...
if ( ! class_exists( 'NT_Customizer' ) ) {
  class NT_Customizer {
    ...
    public static function customize_css() {
      ...
      $text_color         = get_theme_mod( 'text_color', '#73757a' );
      $header_background  = get_theme_mod( 'header_background', '#fefefe' );
      $header_color       = get_theme_mod( 'header_color', '#151922' );
      $anchor_color       = get_theme_mod( 'anchor_color', '#4687ff' );
      $anchor_hover_color = get_theme_mod( 'anchor_hover_color', '#90b7ff' );

      if ( '#73757a' != $text_color || '#fefefe' != $header_background || '#151922' != $header_color || '#4687ff' != $anchor_color || '#90b7ff' != $anchor_hover_color ) :
        ?>
        <style id="customizer-styles" type="text/css">
          <?php if ( '#73757a' != $text_color ) : ?>
          body {
          ...
          .dropdown.menu > li.is-dropdown-submenu-parent > a::after {
            border-color: <?php echo $anchor_color; ?> transparent transparent;
          }

          <?php endif;

          if ( '#90b7ff' != $anchor_hover_color ) : ?>
          a:hover,
          a:focus,
