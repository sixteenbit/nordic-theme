...
if ( ! class_exists( 'NT_Tags' ) ) {
	...
	class NT_Tags {
		...
		public static function foundation_pagination( $args = array() ) {
			...
			if ( $firstpage && ( 1 != $page ) ) {
				$echo .= '<li><a href="' . $firstpage . '"><span class="show-for-sr">' . __( 'First', 'nordic-theme' ) . '</span><i class="fas fa-angle-double-left"></i></a></li>';
			}

			if ( $previous && ( 1 != $page ) ) {
				$echo .= '<li><a href="' . $previous . '" title="' . __( 'previous', 'nordic-theme' ) . '"><span class="show-for-sr">' . $args['previous_string'] . '</span><i class="fas fa-angle-left"></i></a></li>';
			}
			...
			if ( $next && ( $count != $page ) ) {
				$echo .= '<li><a href="' . $next . '" title="' . __( 'next', 'nordic-theme' ) . '"><span class="show-for-sr">' . $args['next_string'] . '</span><i class="fas fa-angle-right"></i></a></li>';
			}

			$lastpage = esc_attr( get_pagenum_link( $count ) );
			if ( $lastpage ) {
				$echo .= '<li><a href="' . $lastpage . '"><span class="show-for-sr">' . __( 'Last', 'nordic-theme' ) . '</span><i class="fas fa-angle-double-right"></i></a></li>';
			}
